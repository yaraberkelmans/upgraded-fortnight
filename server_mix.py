...
model_params = {
    ...
    "schelling_weight": {"type": "SliderFloat", "value": 2.00, "min": 0.0, "max": 5.0, "step": 0.01, "label": "Schelling relocation weight"},
    ...
    "base_aggression_weight": {"type": "SliderFloat", "value": 1.00, "min": 0.0, "max": 3.0, "step": 0.01, "label": "Group baseline aggression weight"},
    ...
    "own_group_weight": {"type": "SliderFloat", "value": 0.70, "min": 0.0, "max": 3.0, "step": 0.01, "label": "Own-group confidence weight"},
