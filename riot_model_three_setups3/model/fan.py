...
class Fan:
    ...
    def __init__(self, model, group: FanGroup, is_respawn: bool = False):
        ...
        # Assigned by the runner at the start of the measurement phase.
        # Fans created later through respawning keep -1 and are excluded from
        # the fixed-cohort analysis.
        self.measurement_cohort_id = -1
