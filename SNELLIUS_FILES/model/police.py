...
Description: This file contains the police class and all its related logic. VECTORIZED VERSION.
"""
...
class Police:
    ...
    def arrest(self, fan):
        # Capture the arrested fan before removal. The runner later adds the
        # measurement-step index, so the model only stores fan properties here.
        self.model.arrested_fans_this_step.append(
            (
                bool(fan.is_respawn),
