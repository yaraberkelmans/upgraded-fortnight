...
Description: Visualization for the segregation model. Contains the SolaraViz page that allows users to interactively explore the segregation model by adjusting parameters and visualizing the results in real-time.
